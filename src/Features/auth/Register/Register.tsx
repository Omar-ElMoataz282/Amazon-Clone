...
import "../style.css";
import AddAccountToStorage from "../../../Utils/auth/AddAccountToStorage";
import AddCurAccountToStorage from "../../../Utils/auth/AddCurAccountToStorage";
...
function Regsiter() {
  ...
  function handleSubmit(e: { preventDefault: () => void }) {
    ...
    if (name.trim() === "" || email.trim() === "" || password.trim() === "") {
      ...
      const result = AddAccountToStorage({
        name: name,
        email: email,
        password: password,
      });
    ...
    <div className="bg-white d-flex flex-column gap-2 gap-md-4 align-items-center pt-3 pt-md-4 calc-height-form">
      ...
      <div className="border rounded p-3 p-md-4 col-11 col-sm-8 col-lg-4">
        <h5 className="mb-0 mb-md-3">
          ...
          <Link className="text-black text-decoration-underline" to="/register">
